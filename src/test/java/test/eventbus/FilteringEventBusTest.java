...
public class FilteringEventBusTest {
    @Test
    public void produce_without_consumers_should_run() {
        FilteringEventBusImpl<Object> bus = new FilteringEventBusImpl<Object>();
    ...
    public void subscribe_filtered_then_produce_should_call_consumer_once() {
        FilteringEventBusImpl<Event> bus = new FilteringEventBusImpl<Event>();
